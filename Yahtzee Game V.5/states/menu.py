...
class Menu(BaseState):
    def __init__(self):
        ...
        self.optionsButton = Button(158, 296, "OPTIONS", 186, 67, "", 50, "Blue", pygame.display.get_surface(), 2)
        self.highScoresButton = Button(158, 371, "HIGHSCORES", 186, 69, "", 50, "Blue", pygame.display.get_surface(), 2)
    ...
    def get_event(self, event):
        ...
        if event.type == pygame.MOUSEBUTTONUP:
            ...
            clickableButtonsOnMenu = [self.startButton.checkClicked(mouseX, mouseY), 
                                      ...
                                      self.optionsButton.checkClicked(mouseX, mouseY),
    ...
    def draw(self, surface):  
        ...
        self.optionsButton.displayButton()
